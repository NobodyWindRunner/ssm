    ...
    <form name="form1" method="post" action="../project/list" id="form1">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                ...
                <div class="r-list">
                    ...
                    <a id="lbtnSearch" class="btn-search"  onclick="location.href='../project/like?proName='+document.getElementById('txtKeywords').value;return false;">查询</a> </div>
            </div>
        </div>
        <!--/工具栏-->
        <!--文字列表-->
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable" id="ltable">
            ...
            <tr align="center">
                ...
                <td>${obj.proName }</td>
                <td>${obj.detail }</td>
                <td id="statusVal">${obj.statusVal==1?"进行中":"未启动" }</td>
                <td>
