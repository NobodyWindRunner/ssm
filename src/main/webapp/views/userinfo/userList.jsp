...
<body class="mainbody">
    <form name="form1" method="post" action="../userinfo/list" id="form1">
        <!--导航栏-->
        <div class="location">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="../userinfo/new"><i></i><span>新增</span></a></li>
                ...
                <div class="r-list">
                    ...
                    <a id="lbtnSearch" class="btn-search"  onclick="location.href='../userinfo/like?loginName='+document.getElementById('txtKeywords').value;return false;">查询</a>
                </div>
            </div>
        </div>
        <!--/工具栏-->
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
            ...
            <tr align="center">
                ...
                <td>${obj.loginName }</td>
                <td>${obj.password }</td>
                <td>${obj.statusVal==1?"可用":"不可用" }</td>
                <td>
                <a href="../userinfo/del?id=${obj.id }&page=${data.page }" onclick="return confirm('是否确认要删除该数据?');">删除</a>
                <a href="../userinfo/get?id=${obj.id }&page=${data.page }">修改</a></td>
            </tr>
            </c:forEach>
        </table>
        <!--/文字列表-->
	    ...
	    <div class="pagelist">
			...
			<pt:page count="${data.count }" pageIndex="${data.page }"	url="../userinfo/list?size=${size}&" pageMax="${data.total}" />
		</div>
		<!--/内容底部-->
    </form>
</body>
