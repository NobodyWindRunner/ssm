...
<body class="mainbody">
    <form name="form1" method="post" action="../department/list" id="form1">
        <!--导航栏-->
        <div class="location">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="../department/new"><i></i><span>新增</span></a></li>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
            ...
            <tr align="center">
                ...
                <td>${obj.id }</td>
                <td><a href="../department/listForEmp?id=${obj.id }">${obj.name }</a></td>
                <td>
                <a href="../department/del?id=${obj.id }&page=${data.page }" onclick="return confirm('是否确认要删除该数据?');">删除</a>
                <a href="../department/get?id=${obj.id }&page=${data.page }">修改</a></td>
            </tr>
            </c:forEach>
        </table>
        <!--/文字列表-->
	    ...
	    <div class="pagelist">
			...
			<pt:page count="${data.count }" pageIndex="${data.page }"	url="../department/list?size=${size}&" pageMax="${data.total}" />
		</div>
		<!--/内容底部-->
    </form>
</body>
